...
class CustomArguments:
    ...
    bias_type: Optional[str] = field(default="race", metadata={"help": "The type of bias attributes."})
    model_id: Optional[str] = field(
        default="bert-base-uncased",
        metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"},
    )
    student_encoder_id: Optional[str] = field(
        default="../../debias_encoder/race/out/race_enc00_0.5_100_20",
        metadata={"help": "Path to debiased encoder model or debiased model identifier from huggingface.co/models"},
    )
    ...
    precision: Optional[int] = field(default=0, metadata={"help": "The floating point of the operations."})
    use_wandb: Optional[bool] = field(default=False, metadata={"help": "Whether to use WandB or not."})
    debias_ratio: Optional[float] = field(default=0.0, metadata={"help": "A debiasing ratio for objective."})
    freeze_student_encoder: Optional[bool] = field(
        default=False, metadata={"help": "Whether to freeze the student model encoder module or not."}
    )
